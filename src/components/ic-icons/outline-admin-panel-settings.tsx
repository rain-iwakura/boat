...
const AdminPanelSettingsOutlinedIcon = createIcon(() => (
	<svg width="1em" height="1em" viewBox="0 0 24 24">
		<circle cx="17" cy="15.5" r="1.12" fill="currentColor" fill-rule="evenodd" />
		<path
			fill="currentColor"
			fill-rule="evenodd"
...
export default AdminPanelSettingsOutlinedIcon;
